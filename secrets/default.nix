{ lib, ... }: {
  ...
  age.secrets."mailserver/mihaly-password" =
    lib.mkDefault { file = ./mailserver/mihaly-password.age; };
  age.secrets."mailserver/aws-ses-sasl" =
    lib.mkDefault { file = ./mailserver/aws-ses-sasl.age; };
